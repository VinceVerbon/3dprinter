<#
.SYNOPSIS
  Create a git worktree for the 3dprinter repo under E:\Dev\worktrees\3dprinter\<branch>.

.DESCRIPTION
  Run from the main checkout (E:\Dev\3dprinter) or anywhere inside it.
...
.EXAMPLE
  ...
  # creates branch "calibration" from HEAD and worktree at E:\Dev\worktrees\3dprinter\calibration
...
if (-not $repoRoot) {
  Write-Error "Not inside a git repo. cd to E:\Dev\3dprinter first."
  exit 1
}

$parent = 'E:\Dev\worktrees\3dprinter'
