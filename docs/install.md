...
```powershell
# 1. Clone (uses the github-vverbon SSH alias on the kantoor workstation)
git clone github-vverbon:VinceVerbon/3dprinter.git E:\Dev\3dprinter
cd E:\Dev\3dprinter\app
npm install
